...
GUILD_ID = 1098657843848155167  # replace with your guild id
MY_GUILD = discord.Object(id=GUILD_ID)  # replace with your guild id
AI_LOADED = False
BOT_TOKEN = "MTA5ODY1ODUwMzA0NTk1OTY4Mg.Gz8Rrx.leF_IgiU-tqAsZz02oxCJxn2wjb8a-yBtYaJ0I"
...
async def invite(interaction: discord.Interaction):
    ...
    embed.url = "https://discord.com/api/oauth2/authorize?client_id=1098658503045959682&permissions=8&scope=bot"
    await interaction.response.send_message(embed=embed)
